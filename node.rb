...
SETTINGS = {
  :url          => "https://tbsoares.servehttp.com",
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/tbsoares.servehttp.com.pem",
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/tbsoares.servehttp.com.pem"
}
